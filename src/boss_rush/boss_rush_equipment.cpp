...
constexpr GearRule kRules[] = {
    ...
    {"Deku Toad",       6, 0,                3, false, 0},
    {"Morpheel",        6, IT_CLAW | IT_BOOTS,              3, false, 1},
    {"Death Sword",     8, IT_BOW | IT_CLAW, 4, true,  0},
    {"Stallord",        8, IT_SPIN,          4, true,  0},
    {"Darkhammer",      10, IT_CLAW,          5, true,  0},
